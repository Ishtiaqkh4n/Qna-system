...
import { avatar as avatars } from "@/models/client/config";
import {
    answerCollection,
    db,
    voteCollection,
    ...
    const [enrichedComments, enrichedAnswers] = await Promise.all([
        ...
        Promise.all(
            answers.documents.map(async answer => {
                ...
                const enrichedAnswerComments = await Promise.all(
                ...
                return {
                    ...answer,
                    comments: { total: answerComments.total, documents: enrichedAnswerComments },
                    upvotesDocuments: { total: upvotes.total, documents: [] },
                    downvotesDocuments: { total: downvotes.total, documents: [] },
                    author: {
                        $id: author.$id,
                        name: author.name,
                        reputation: author.prefs.reputation,
            ...
            <div className="relative mx-auto px-4 pb-20 pt-36">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <Comments
                            comments={{ total: comments.total, documents: enrichedComments }}
                            className="mt-4"
                            type="question"
                            typeId={question.$id}
                        />
                ...
                <Answers answers={{ total: answers.total, documents: enrichedAnswers }} questionId={question.$id} />
            </div>
        </TracingBeam>
    );
};
