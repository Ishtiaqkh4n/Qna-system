...
const Page = async ({
    ...
    const query = [
        ...
        Query.offset((+sp.page - 1) * 25),
        Query.limit(25),
    ];

    if (sp.voteStatus) query.push(Query.equal("voteStatus", sp.voteStatus));
                    ...
                    <li>
                        <Link
                            ...
                            className={`block w-full rounded-full px-3 py-0.5 duration-200 ${
                                !sp.voteStatus ? "bg-white/20" : "hover:bg-white/20"
                            }`}
                        >
                            All
                        </Link>
