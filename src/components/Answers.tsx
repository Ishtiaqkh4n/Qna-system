...
import { avatar as avatars, databases } from "@/models/client/config";
...
const Answers = ({
    ...
    return (
        <>
            ...
            {(answers.documents as any[]).map((answer: any) => (
            ...
            <form onSubmit={handleSubmit} className="space-y-2">
                ...
                <RTE value={newAnswer} onChange={(value?: string) => setNewAnswer(() => value || "")} />
